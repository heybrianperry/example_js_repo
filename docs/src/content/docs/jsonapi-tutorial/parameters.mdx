...
<Tabs>
  ...
  <TabItem label="Data">
    <JsonView client:only collapsed={2} src={recipesMedia} />
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="Data">
    <JsonView client:only collapsed={2} src={recipesThumbnail} />
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="Data">
    <JsonView client:only collapsed={2} src={recipesFilter} />
  </TabItem>
</Tabs>
