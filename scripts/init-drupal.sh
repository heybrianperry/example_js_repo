...
ddev composer require drush/drush drupal/decoupled_router drupal/jsonapi_extras drupal/simple_oauth:^5.0

# Install Drupal
ddev drush site:install demo_umami --account-name=admin --account-pass=admin -y
ddev drush en jsonapi decoupled_router basic_auth jsonapi_extras simple_oauth -y
